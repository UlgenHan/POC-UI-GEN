...
import { componentManifestSchema, ComponentManifest } from '../validators/schemas.js';
import { FileMerger } from '../utils/FileMerger.js';

export class ComponentBuilder {
  constructor(private params: { templatesRoot: string; outputDir: string; componentsLibRoot: string }) {}

  async buildFromManifest(manifestPath: string): Promise<{ manifest: ComponentManifest; wrapperFilename: string }> {
